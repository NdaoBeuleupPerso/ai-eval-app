...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '0126478b-7259-4e6a-bd85-892bfed70ea8' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('a9c60666-550e-4f4f-8fe6-156716b510de');
      cy.get(`[data-cy="name"]`).should('have.value', 'a9c60666-550e-4f4f-8fe6-156716b510de');
