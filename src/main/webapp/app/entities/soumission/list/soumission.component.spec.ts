...
import { sampleWithRequiredData } from '../soumission.test-samples';
...
describe('Soumission Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.soumissions()[0]).toEqual(expect.objectContaining({ id: 4418 }));
  });

  describe('trackId', () => {
    it('should forward to soumissionService', () => {
      const entity = { id: 4418 };
      jest.spyOn(service, 'getSoumissionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSoumissionIdentifier).toHaveBeenCalledWith(entity);
